                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative flex-grow md:flex-grow-0">
                            <select
                                ...
                                className="w-full bg-white/5 border border-white/10 px-4 py-2.5 rounded-xl text-white text-sm outline-none appearance-none pr-10 hover:border-white/30 transition-all"
                            >
                ...
                <div className="flex gap-8 relative">
                    ...
                    <div className="flex-grow">
                        ...
                        {loading ? (
                            ...
                            <div className="glass rounded-[var(--radius)] py-20 flex flex-col items-center justify-center text-center">
                                ...
                                <button onClick={clearAll} className="btn-primary">مسح جميع الفلاتر</button>
                            </div>
                        )}
                    </div>
                </div>
